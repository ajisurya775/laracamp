                ...
                <div class="row">
                    <div class="col-lg-5 col-12">
                        <div class="item-bootcamp">
                            <img src="{{ asset('template/assets/images/item_bootcamp.png')}}" alt="" class="cover">
                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('checkout.store',$camp->id)}}" method="POST" class="basic-form">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="occopation" type="text" class="form-control {{ $errors->has('occopation') ? 'is-invalid' : ''}}" value="{{ old('occopation') ?:Auth::user()->occopation}}" >
                                @if ($errors->has('occopation'))
                                    <p class="text-danger">{{ $errors->first('occopation')}}</p>
                                @endif
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input name="cvc" type="text" class="form-control {{ $errors->has('cvc') ? 'is-invalid':''}}" maxlength="3" value="{{ old('cvc') ?:''}}">
                                        @if ($errors->has('cvc'))
                            ...
                            <p class="text-center subheader mt-4">
                                <img src="{{ asset('template/assets/images/ic_secure.svg')}}" alt=""> Your payment is secure and encrypted.
                            </p>
                        </form>
                    </div>
                </div>
